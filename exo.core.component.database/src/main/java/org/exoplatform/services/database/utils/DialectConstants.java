...
public class DialectConstants
{
   ...
   /**
    * DB_DIALECT_MYSQL_TOKUDB.
    */
   public final static String DB_DIALECT_MYSQL_TOKUDB = "MYSQL-TOKUDB";

   /**
    * DB_DIALECT_MYSQL_TOKUDB_UTF8.
    */
   public final static String DB_DIALECT_MYSQL_TOKUDB_UTF8 = "MYSQL-TOKUDB-UTF8";
   ...
   public final static String[] DB_DIALECTS = {DB_DIALECT_GENERIC, DB_DIALECT_ORACLE, DB_DIALECT_ORACLEOCI,
      ...
      DB_DIALECT_MYSQL_MYISAM_UTF8, DB_DIALECT_MYSQL_TOKUDB, DB_DIALECT_MYSQL_TOKUDB_UTF8};
