 ...
 * @version $Id:$
 */
public class ExoCacheCollectionRegionReadOnlyAccessStrategy extends ExoCacheAccessStrategy implements
   CollectionRegionAccessStrategy
{

   public ExoCacheCollectionRegionReadOnlyAccessStrategy(ExoCacheTransactionalDataRegion region)
   {
      super(region);
   }
