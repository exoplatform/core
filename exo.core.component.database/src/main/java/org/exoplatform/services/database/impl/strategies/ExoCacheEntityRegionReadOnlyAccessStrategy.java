 ...
 * @version $Id:$
 */
public class ExoCacheEntityRegionReadOnlyAccessStrategy extends ExoCacheAccessStrategy implements
   EntityRegionAccessStrategy
{

   public ExoCacheEntityRegionReadOnlyAccessStrategy(ExoCacheTransactionalDataRegion region)
   {
      super(region);
   }
