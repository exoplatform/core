 ...
 * @version $Id:$
 */
public class ExoCacheNaturalIdRegionReadOnlyAccessStrategy extends ExoCacheAccessStrategy implements
   NaturalIdRegionAccessStrategy
{

   public ExoCacheNaturalIdRegionReadOnlyAccessStrategy(ExoCacheTransactionalDataRegion region)
   {
      super(region);
   }
